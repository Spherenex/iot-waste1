  ...
  //  const apiKey = "AIzaSyAdz2-FRDmMzBzHLvC32nSRy5dzqD9n9Q8ww";
  //  const sheetId = "1ycxX3IS5hzzpoImWEY7KYfD8X90Cem7kxBDUYvG_phc";
  ...
  //            .card-temperature {
  //              background: linear-gradient(to bottom, #fecaca, #f9a8d4);
  //            }
  ...
  //            .card-humidity {
  //              background: linear-gradient(to bottom, #ccfbf1, #fbcfe8);
  //            }
  ...
  //            .card-turbidity {
  //              background: linear-gradient(to bottom, #fef08a, #cffafe);
  //            }
  ...
  //            /* CombinedGraph Component */
  //            .combined-graph-container {
  //              width: 100%;
  //              max-width: 640px;
  //              margin-top: 16px;
  //              background: linear-gradient(to bottom, #cffafe, #c4b5fd);
  //              border-radius: 8px;
  //              box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
  //              padding: 16px;
  //            }

  //            /* SeparateGraphs Component */
  ...
  import SmartIndoorFarming from './components/SmartIndoorFarming'
  import GoogleSheetViewer from './components/GoogleSheetViewer'
  import Farming from './components/Farming'
  import Iot_waste from './components/Iot_waste'
  import './App.css'
  function App() {
    return (
      <div>
